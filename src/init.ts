...
// 生成验证命令提示，写入 MINI.md。告诉 AI：修改代码前，运行哪些命令校验代码
...
// 读取现有.gitignore；不存在则新建，写入注释 + 两条忽略规则
